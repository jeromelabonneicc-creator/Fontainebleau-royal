...
export const solidarityActions = [
  ...
  { icon: "hygiene", title: "Kits d’hygiène", copy: "offerts" },
  { icon: "shirt", title: "Vestiaire solidaire", copy: "à prix symbolique ou offert" },
  { icon: "messages", title: "Permanences d’assistance", copy: "sociale, administrative et professionnelle" }
];
